$(document).ready(function() {
  ...
  var POINT_X = 'Year'; // column name for x values in data.csv
  var POINT_X_PREFIX = 'Year'; // prefix for x values, eg 'Year'
  var POINT_X_POSTFIX = ''; // postfix for x values, eg '%'

  var POINT_Y = 'Normalised retractions'; // column name for y values in data.csv
  var POINT_Y_PREFIX = 'Norm. Retractions'; // prefix for x values, eg 'USD '
  var POINT_Y_POSTFIX = ''; // postfix for x values, eg ' kg'

  var POINT_NAME = 'Number of Retractions'; // point names that appear in tooltip
  var POINT_COLOR = 'rgba(0,0,255,0.7)'; // eg `black` or `rgba(10,100,44,0.8)`
  var POINT_RADIUS = 5; // radius of each data point

  var X_AXIS = 'Year'; // x-axis label, label in tooltip
  var Y_AXIS = 'Normalised Retractions'; // y-axis label, label in tooltip
